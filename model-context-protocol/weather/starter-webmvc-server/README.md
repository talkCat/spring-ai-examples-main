...
1. Create a `mcp-servers-bean.json` configuration file with this content:
...
```bash
java -Dspring.ai.mcp.client.stdio.servers-configuration=file:mcp-servers-bean.json \
