...
- ✅ **Port Kotlin test to AI validation**
  - ✅ Update `kotlin/kotlin-hello-world` ExampleInfo.json with AI validation bean
...
- [ ] Update `scaffold_integration_test.py` to support AI validation bean
...
├── scripts/
│   └── scaffold_integration_test.py  # Updated for AI bean
└── docs/
