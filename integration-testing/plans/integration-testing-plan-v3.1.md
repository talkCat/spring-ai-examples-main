        ...
        with tempfile.NamedTemporaryFile(mode="w+", delete=False, suffix=".log") as tmp:
            try:
                ...
                result = subprocess.run(
                    ...
                    text=True,
                    timeout=bean.get("timeoutSec", 300)
                )
                ...
                success_patterns = bean.get("successRegex", [])
                failed_patterns = []
                ...
                return launcher, False, f"Timeout after {bean.get('timeoutSec', 300)}s"
